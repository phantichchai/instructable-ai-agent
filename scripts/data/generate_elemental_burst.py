...
dir = os.path.join("dataset", "elemental_burst")
...
for switch in [2, 3, 4, 1]:
    dataset_generator.generate(ActionMapping.ELEMENTAL_BURST, f"[ACTION] {ActionPromptMapping[ActionMapping.ELEMENTAL_BURST]}", 2)
